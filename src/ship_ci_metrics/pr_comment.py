...
This module processes comparison artifacts from all matrix configurations and
...
def parse_comparison_file(comparison_file: Path) -> dict[str, Any]:
    ...
    if "No significant differences found" in content or "No differences found" in content:
